...
object ResourceReferenceResolver {
    fun resolveReference(baseUri: String, reference: String): String {
        ...
        val combined = when {
            baseDir.isEmpty() -> reference
            else -> "$baseDir/$reference"
        }
    ...
    private fun normalize(value: String): String =
        if (value.contains("://")) RefParser.normalizeUri(value) else value
